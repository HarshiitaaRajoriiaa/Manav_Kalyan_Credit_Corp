...
//             to="/"
//             className={({ isActive }) =>
//               `hover:bg-blue-200 p-1 rounded-xl pr-2 pl-2 transition ${
...
//             >
//               <button className="flex items-center gap-1 hover:bg-blue-200 p-1 rounded-xl pr-2 pl-2 transition">
...
//               <NavLink
//                 to="/"
//                 className="block py-2 hover:bg-blue-200"
...
//                     )
//                   }
//                   className="w-full flex justify-center items-center py-2 px-4 hover:bg-blue-200"
//                 >
//                   {item.title}
  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center ">
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-6  font-semibold">
          <NavLink to="/" className=" hover:bg-blue-200 p-1 rounded-xl pr-2 pl-2 transition">
            Home
          </NavLink>
          <NavLink to="/about" className="hover:bg-blue-200 p-1 rounded-xl pr-2 pl-2 transition">
            About Us
          </NavLink>
          <NavLink to="/contact" className="hover:bg-blue-200 p-1 rounded-xl pr-2 pl-2 transition">
            Contact Us
          </NavLink>
          ...
          {menuItems.map((item, index) => (
            <div key={index} className="relative">
              <button
                className="flex items-center gap-1 hover:bg-blue-200 p-1 rounded-xl pr-2 pl-2 transition"
                onClick={() =>
          ...
          {["Code of Conduct", "Career", "Privacy Policy", "Legal"].map(
            (link, index) => (
              <NavLink
                key={index}
                to={`/${link.toLowerCase().replace(/ /g, "-")}`}
                className="hover:bg-blue-200 p-1 rounded-xl pr-2 pl-2 transition"
              >
                {link}
              </NavLink>
            )
